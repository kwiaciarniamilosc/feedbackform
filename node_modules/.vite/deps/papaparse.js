  ...
  "node_modules/papaparse/papaparse.min.js"(exports, module) {
    ((e, t) => {
      ...
      function E(C) {
        ...
        if (void 0 !== C.escapeChar && (F = C.escapeChar), ("string" != typeof S || -1 < v.BAD_DELIMITERS.indexOf(S)) && (S = ","), x === S)
        ...
        this.parse = function(i2, t, r2) {
          ...
          if (T || false !== T && -1 === i2.indexOf(L)) {
            for (var l2 = i2.split(O), c2 = 0; c2 < l2.length; c2++) {
              if (d2 = l2[c2], j += d2.length, c2 !== l2.length - 1)
                j += O.length;
              else if (r2)
                return b();
              if (!x || d2.substring(0, a2) !== x) {
                if (o2) {
                  if (h2 = [], k(d2.split(S)), R(), z)
                    return b();
                } else
                  k(d2.split(S));
                if (A && A <= c2)
          ...
          for (var p2 = i2.indexOf(S, j), g2 = i2.indexOf(O, j), _2 = new RegExp(M(F) + M(L), "g"), m2 = i2.indexOf(L, j); ; )
            if (i2[j] === L)
              for (m2 = j, j++; ; ) {
                if (-1 === (m2 = i2.indexOf(L, m2 + 1)))
                  return r2 || u2.push({ type: "Quotes", code: "MissingQuotes", message: "Quoted field unterminated", row: h2.length, index: j }), E2();
                if (m2 === n2 - 1)
                  return E2(i2.substring(j, m2).replace(_2, L));
                if (L === F && i2[m2 + 1] === F)
                  m2++;
                  ...
                  if (i2.substring(m2 + 1 + y2, m2 + 1 + y2 + s2) === O) {
                    if (d2.push(i2.substring(j, m2).replace(_2, L)), w2(m2 + 1 + y2 + s2), p2 = i2.indexOf(S, j), m2 = i2.indexOf(L, j), o2 && (R(), z))
                      return b();
                    if (A && h2.length >= A)
                      return b(true);
                    break;
              ...
              d2.push(i2.substring(j, p2)), j = p2 + e, p2 = i2.indexOf(S, j);
            else {
              if (-1 === g2)
                break;
              if (d2.push(i2.substring(j, g2)), w2(g2 + s2), o2 && (R(), z))
                return b();
              if (A && h2.length >= A)
                return b(true);
            }
      ...
      function g(e) {
        ...
        if (t.error)
          ...
          if (P(i2.userStep)) {
            ...
            P(i2.userChunk) && (i2.userChunk(t.results, n2, t.file), delete t.results);
        }
      ...
      return v.parse = function(e, t) {
        ...
        if (t.dynamicTyping = i2, t.transform = !!P(t.transform) && t.transform, !t.worker || !v.WORKERS_SUPPORTED)
          return i2 = null, v.NODE_STREAM_INPUT, "string" == typeof e ? (e = ((e2) => 65279 !== e2.charCodeAt(0) ? e2 : e2.slice(1))(e), i2 = new (t.download ? f : c)(t)) : true === e.readable && P(e.read) && P(e.on) ? i2 = new p(t) : (n.File && e instanceof File || e instanceof Object) && (i2 = new l(t)), i2.stream(e);
        (i2 = (() => {
          var e2;
        ...
        function e() {
          if (0 === h2.length)
            ...
            if (P(o2.before)) {
              ...
              if ("object" == typeof s2) {
                if ("abort" === s2.action)
                  return e2 = "AbortError", t = n2.file, i3 = n2.inputElem, r2 = s2.reason, void (P(o2.error) && o2.error({ name: e2 }, t, i3, r2));
                if ("skip" === s2.action)
                  return void u2();
